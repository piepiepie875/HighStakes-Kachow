...
void redNegative() {
  chassis.setPose(85, 128, 328);
  chassis.moveToPoint(82.25, 134.5, 2000);
  pros::delay(100);
  curAngle = 3;
  pros::delay(500);
  ...
  pros::delay(1000);
  Clamp.set_value(true);
  chassis.turnToPoint(110, 84, 700);
  Intake.move_velocity(600);
  chassis.moveToPoint(110, 84, 2000);
  chassis.turnToHeading(90, 700);
  chassis.moveToPoint(131, 87.5, 2500);
  chassis.moveToPoint(96, 96, 2500, {.forwards = false});
  chassis.moveToPoint(119, 102, 2000);
  chassis.turnToHeading(0, 500);
  chassis.moveToPoint(117, 136, 2000);
  chassis.turnToPoint(127, 146, 500);
  Intake.move_velocity(0);
  chassis.moveToPoint(127, 146, 1200, {.maxSpeed = 50});
  pros::delay(400);
  Intake.move_velocity(600);
  pros::delay(800);
  chassis.moveToPoint(109, 128, 1000, {.forwards = false});
  chassis.moveToPoint(121, 138, 600);
  chassis.moveToPoint(109, 128, 1000, {.forwards = false});
  pros::delay(200);
  chassis.turnToPoint(68, 108, 1000);
  chassis.moveToPoint(68, 108, 2000, {.minSpeed = 80});
}
