...
//  }
 ...
 void blueTournamentNegative() {
  chassis.setPose(91, 22, 15);
  chassis.moveToPoint(98.5, 63.5, 2000);
  RightDoinker.set_value(true);
  Intake.move_velocity(600);
  pros::delay(100);
  chassis.moveToPoint(75, 50.5, 3000, {.forwards =  false});
  pros::delay(350);
  ...
  Intake.move_velocity(600);
  chassis.moveToPoint(112, 44, 2000, {.maxSpeed = 90});
  chassis.moveToPoint(106, 44, 2000, {.forwards = false, .maxSpeed = 90});
  chassis.turnToHeading(180, 1000);
  chassis.moveToPoint(111, 13, 2000);
  Intake.move_velocity(0);
  chassis.turnToHeading(135, 1000);
  chassis.moveToPoint(130, -4, 1500, {.maxSpeed = 50});
  Intake.move_velocity(600);
  pros::delay(1200);
  chassis.moveToPoint(100, 21, 2000, {.forwards = false});
  pros::delay(500);
  chassis.moveToPoint(120, 10, 2000);
  pros::delay(600);
  chassis.moveToPoint(108, 21, 2000, {.forwards = false});
  chassis.turnToHeading(270, 1000);
  chassis.moveToPoint(60, 15, 2000);
